...
To install jarmscan, download a binary from the [releases](https://github.com/projectdiscovery/jarm-go/releases) page or install using `go install github.com/projectdiscovery/jarm-go/cmd/jarmscan@latest`.
