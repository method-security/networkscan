...
type SshEnumerateReport struct {
	Targets    []string               `json:"targets,omitempty" url:"targets,omitempty"`
	SshDetails []*SshEnumerateDetails `json:"sshDetails,omitempty" url:"sshDetails,omitempty"`
...
func (s *SshEnumerateReport) GetExtraProperties() map[string]interface{} {
	return s.extraProperties
}

func (s *SshEnumerateReport) UnmarshalJSON(data []byte) error {
	type unmarshaler SshEnumerateReport
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*s = SshEnumerateReport(value)
...
func (s *SshEnumerateReport) String() string {
	if len(s._rawJSON) > 0 {
		if value, err := core.StringifyJSON(s._rawJSON); err == nil {
			return value
		}
