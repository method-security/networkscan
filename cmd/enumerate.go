...
func (a *NetworkScan) InitEnumerateCommand() {
	...
	enumerateServiceCmd.Flags().String("service", "", "Service to enumerate (ftp, grpc, imap, ldap, mongodb, mssql, mysql, pop3, postgres, redis, smb, smtp, snmp, socks, ssh, tr069)")
