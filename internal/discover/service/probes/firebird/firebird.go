...
func (p *FirebirdPlugin) Run(conn net.Conn, timeout time.Duration, target probe.Target) (*probe.Service, error) {
...
func (p *FirebirdPlugin) Type() probe.Protocol {
	return probe.TCP
}
...
var defaultFirebirdPluginPorts = probe.Ports((&FirebirdPlugin{}).PortPriority)

func (p *FirebirdPlugin) DefaultPorts() []int { return defaultFirebirdPluginPorts }
func (p *FirebirdPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*probe.Service, error) {
