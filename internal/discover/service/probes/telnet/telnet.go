...
func (p *TELNETPlugin) Run(conn net.Conn, timeout time.Duration, target probe.Target) (*probe.Service, error) {
...
func (p *TELNETPlugin) Type() probe.Protocol {
	return probe.TCP
}
...
var defaultTELNETPluginPorts = probe.Ports((&TELNETPlugin{}).PortPriority)

func (p *TELNETPlugin) DefaultPorts() []int { return defaultTELNETPluginPorts }
func (p *TELNETPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*probe.Service, error) {
