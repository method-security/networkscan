...
func (p *SybasePlugin) Type() probe.Protocol {
	return probe.TCP
}
...
func (p *SybasePlugin) Run(conn net.Conn, timeout time.Duration, target probe.Target) (*probe.Service, error) {
...
var defaultSybasePluginPorts = probe.Ports((&SybasePlugin{}).PortPriority)

func (p *SybasePlugin) DefaultPorts() []int { return defaultSybasePluginPorts }
func (p *SybasePlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*probe.Service, error) {
