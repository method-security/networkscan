...
func (p *IMAPPlugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
...
func (p *IMAPPlugin) Type() common.TransportType {
...
var defaultIMAPPluginPorts = helpers.Ports((&IMAPPlugin{}).PortPriority)

func (p *IMAPPlugin) DefaultPorts() []int { return defaultIMAPPluginPorts }
func (p *IMAPPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
