...
func (p *SMPPPlugin) Type() common.TransportType {
	return common.TransportTypeTcp
}
func (p *SMPPPlugin) Priority() int {
	return 55
}
func (p *SMPPPlugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
...
var defaultSMPPPluginPorts = helpers.Ports((&SMPPPlugin{}).PortPriority)

func (p *SMPPPlugin) DefaultPorts() []int { return defaultSMPPPluginPorts }
func (p *SMPPPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
