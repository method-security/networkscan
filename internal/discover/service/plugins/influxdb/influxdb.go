...
func detectInfluxDBViaPing(conn net.Conn, target helpers.Endpoint, timeout time.Duration) (string, bool, error) {
...
// Returns: (version, detected, error)
func detectInfluxDBViaHealth(conn net.Conn, target helpers.Endpoint, timeout time.Duration) (string, bool, error) {
...
func (p *InfluxDBPlugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
...
func (p *InfluxDBPlugin) Type() common.TransportType {
...
var defaultInfluxDBPluginPorts = helpers.Ports((&InfluxDBPlugin{}).PortPriority)

func (p *InfluxDBPlugin) DefaultPorts() []int { return defaultInfluxDBPluginPorts }
func (p *InfluxDBPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
