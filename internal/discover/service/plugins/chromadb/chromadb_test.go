...
func TestChromaDBPluginInterface(t *testing.T) {
	...
	t.Run("Type", func(t *testing.T) {
		if pluginType := plugin.Type(); pluginType != common.TransportTypeTcp {
			t.Errorf("Type() = %v, want TCP (%v)", pluginType, common.TransportTypeTcp)
		}
	})
...
func TestChromaDBTLSPluginInterface(t *testing.T) {
	...
	t.Run("Type", func(t *testing.T) {
		if pluginType := plugin.Type(); pluginType != common.TransportTypeTcptls {
			t.Errorf("Type() = %v, want TCPTLS (%v)", pluginType, common.TransportTypeTcptls)
		}
	})
