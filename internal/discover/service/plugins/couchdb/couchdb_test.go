...
func TestBuildCouchDBHTTPRequest(t *testing.T) {
	...
	assert.Contains(t, request, "User-Agent: networkscan\r\n")
...
func TestPluginMetadata(t *testing.T) {
	...
	assert.Equal(t, common.TransportTypeTcp, plugin.Type())
...
func TestTLSPluginMetadata(t *testing.T) {
	...
	assert.Equal(t, common.TransportTypeTcptls, plugin.Type())
...
func TestPluginsDifferentPorts(t *testing.T) {
	...
	assert.Equal(t, common.TransportTypeTcp, plainPlugin.Type(), "Plain plugin should use TCP transport")
	assert.Equal(t, common.TransportTypeTcptls, tlsPlugin.Type(), "TLS plugin should use TCPTLS transport")
}
