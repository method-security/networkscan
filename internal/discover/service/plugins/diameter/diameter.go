...
func (p *DIAMETERPlugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
	...
	if err != nil {
		...
		return helpers.MetadataResult(target, metadata, false, "", common.TransportTypeTcp), nil
	}
	...
	return helpers.MetadataResult(target, metadata, false, version, common.TransportTypeTcp), nil
}
...
func (p *DIAMETERPlugin) Type() common.TransportType {
...
func (s ServiceDiameter) Type() common.ProtocolType { return common.ProtocolTypeDiameter }

var defaultDIAMETERPluginPorts = helpers.Ports((&DIAMETERPlugin{}).PortPriority)

func (p *DIAMETERPlugin) DefaultPorts() []int { return defaultDIAMETERPluginPorts }
func (p *DIAMETERPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
