...
func (p *FTPPlugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
...
func (p *FTPPlugin) Type() common.TransportType {
...
var defaultFTPPluginPorts = helpers.Ports((&FTPPlugin{}).PortPriority)

func (p *FTPPlugin) DefaultPorts() []int { return defaultFTPPluginPorts }
func (p *FTPPlugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
