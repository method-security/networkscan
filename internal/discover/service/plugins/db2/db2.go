...
func (p *DB2Plugin) Run(conn net.Conn, timeout time.Duration, target helpers.Endpoint) (*discover.ServiceDetails, error) {
...
func (p *DB2Plugin) Type() common.TransportType {
...
var defaultDB2PluginPorts = helpers.Ports((&DB2Plugin{}).PortPriority)

func (p *DB2Plugin) DefaultPorts() []int { return defaultDB2PluginPorts }
func (p *DB2Plugin) Detect(ctx context.Context, ip net.IP, port int, host string, timeout int) (*discover.ServiceDetails, error) {
