...
func TestTCPPluginRegistry(t *testing.T) {
	want := []string{
		...
		"*plugins.Neo4jFingerprinter|neo4j|[7687]",
		"*plugins.Neo4jTLSFingerprinter|neo4j|[7687]",
		"*plugins.EchoFingerprinter|echo|[7]",
		"*plugins.TelnetFingerprinter|telnet|[23]",
		"*plugins.FTPFingerprinter|ftp|[21]",
		"*plugins.SNPPFingerprinter|snpp|[444]",
		"*plugins.KubernetesFingerprinter|kubernetes|[6443]",
		"*plugins.ChromaDBFingerprinter|chromadb|[8000]",
		"*plugins.MilvusFingerprinter|milvus|[19530]",
		"*plugins.PineconeFingerprinter|pinecone|[443]",
		"*plugins.ChromaDBTLSFingerprinter|chromadb|[8000]",
		"*plugins.MilvusMetricsFingerprinter|milvus-metrics|[9091]",
		"*plugins.SMPPFingerprinter|smpp|[2775 2776]",
		"*plugins.DiameterFingerprinter|diameter|[3868]",
		"*plugins.SMTPTLSFingerprinter|smtps|[465]",
		"*plugins.RDPFingerprinter|rdp|[3389]",
		"*plugins.RDPTLSFingerprinter|rdp|[3389]",
		"*plugins.FirebirdFingerprinter|firebird|[3050]",
		"*plugins.CouchDBFingerprinter|couchdb|[5984]",
		"*plugins.ElasticsearchFingerprinter|elasticsearch|[9200]",
		"*plugins.InfluxDBFingerprinter|influxdb|[8086]",
		"*plugins.CouchDBTLSFingerprinter|couchdb|[6984]",
		"*plugins.POP3Fingerprinter|pop3|[110]",
		"*plugins.DB2Fingerprinter|db2|[446 50000]",
		"*plugins.POP3TLSFingerprinter|pop3s|[995]",
		"*plugins.MySQLFingerprinter|MySQL|[3306]",
		"*plugins.MSSQLFingerprinter|mssql|[1433]",
		"*plugins.SybaseFingerprinter|sybase|[5000]",
		"*plugins.LDAPDiscoveryFingerprinter|ldap|[389]",
		"*plugins.LDAPTLSFingerprinter|ldaps|[636]",
		"*plugins.IMAPTLSFingerprinter|imaps|[993]",
		"*plugins.IMAPFingerprinter|imap|[143]",
		"*plugins.KafkaNewFingerprinter|kafkaNew|[9092]",
		"*plugins.KafkaNewTLSFingerprinter|KafkaNewTLS|[9093]",
		"*plugins.KafkaOldFingerprinter|kafkaOld|[9092]",
		"*plugins.KafkaOldTLSFingerprinter|KafkaOldTLS|[9093]",
		"*plugins.VNCFingerprinter|VNC|[5900]",
		"*plugins.RPCFingerprinter|RPC|[111]",
		"*plugins.ModbusFingerprinter|modbus|[502]",
		"*plugins.RedisTLSFingerprinter|redis|[6380]",
		"*plugins.JDWPFingerprinter|jdwp|[3999 5000 5005 8000 8453 8787 8788 9001 18000]",
		"*plugins.MQTT3Fingerprinter|mqtt3|[1883]",
		"*plugins.MQTT3TLSFingerprinter|mqtt3tls|[8883]",
		"*plugins.MQTT5Fingerprinter|mqtt5|[1883]",
		"*plugins.MQTT5TLSFingerprinter|mqtt5tls|[8883]",
		"*plugins.RsyncFingerprinter|rsync|[873]",
		"*plugins.PostgresFingerprinter|postgres|[5432]",
		"*plugins.RTSPFingerprinter|rtsp|[554]",
		"*plugins.HTTPDiscoveryFingerprinter|http|[80 3000 4567 5000 8000 8001 8080 8081 8888 9001 9080 9090 9100]",
		"*plugins.HTTPSFingerprinter|https|[443 8443 9443]",
	}
...
func TestUDPPluginRegistry(t *testing.T) {
	want := map[uint16]string{
		...
		1194:  "*plugins.OpenVPNFingerprinter|OpenVPN|[1194]",
		...
		3478:  "*plugins.STUNFingerprinter|stun|[3478]",
